...
import { 
  Target, Users, TrendingUp, Award, ChevronRight, ArrowRight, 
  Search, BarChart, Globe, Smartphone, PenTool, Video, Mail, 
  Monitor, Settings, Zap, Eye, Shield, Clock, CheckCircle,
  Star, Quote, Play, Phone
} from 'lucide-react';
...
const ServicesPage = () => {
  ...
  const mainServices = [
    {
      ...
      features: ["Market Analysis", "Competitor Research", "Strategic Planning", "ROI Optimization"]
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      features: ["Technical SEO", "Content Optimization", "Performance Tracking", "Reporting"]
    },
    {
      icon: Award,
  ...
  const allServices = [
    { icon: Search, title: "Search Engine Optimization", description: "Boost your organic visibility and drive qualified traffic to your website." },
    { icon: BarChart, title: "Pay-Per-Click Advertising", description: "Maximize ROI with targeted PPC campaigns across Google, Bing, and social platforms." },
    { icon: Globe, title: "Web Design & Development", description: "Create stunning, responsive websites that convert visitors into customers." },
    { icon: Smartphone, title: "Mobile App Marketing", description: "Comprehensive marketing strategies for mobile applications and app stores." },
    { icon: PenTool, title: "Brand Identity Design", description: "Develop compelling brand identities that resonate with your target audience." },
    { icon: Video, title: "Video Marketing", description: "Engaging video content that tells your story and drives conversions." },
    { icon: Mail, title: "Email Marketing", description: "Nurture leads and retain customers with personalized email campaigns." },
    { icon: Monitor, title: "Conversion Rate Optimization", description: "Optimize your website and landing pages for maximum conversion rates." },
    { icon: Settings, title: "Marketing Automation", description: "Streamline your marketing processes with intelligent automation tools." }
  ];

  const processes = [
    { step: "01", title: "Discovery", description: "We analyze your business, market, and goals to create a tailored strategy." },
    { step: "02", title: "Strategy", description: "Develop comprehensive marketing plans aligned with your objectives." },
    { step: "03", title: "Implementation", description: "Execute campaigns with precision and attention to detail." },
    { step: "04", title: "Optimization", description: "Continuously monitor and refine for maximum performance." },
    { step: "05", title: "Reporting", description: "Provide transparent insights and measurable results." }
  ];
  ...
  const packages = [
    ...
    },
    {
      ...
      price: "Rs.5,999",
      period: "/month",
      features: ["Everything in Starter", "PPC Advertising", "Content Creation", "Weekly Reporting", "Phone Support"],
      popular: true
    },
    {
      name: "Enterprise",
      price: "Rs.9,999",
      period: "/month",
      features: ["Everything in Professional", "Custom Strategy", "Dedicated Account Manager", "24/7 Support", "Advanced Analytics"],
      popular: false
    }
  ];
  ...
  const handleCTAAction = (action) => {
    switch (action) {
      case 'consultation':
        ...
        const message = 'Hello DigiOra Media! I would like to get a free consultation for your digital marketing services.';
  ...
  return (
    <>
      <style jsx global>{`
        ...
        .tab-active { background: linear-gradient(135deg, #dc2626, #b91c1c); color: white; }
      `}</style>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/80">Tailored marketing plans</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="text-white/80">Data-driven optimization</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-6 leading-tight">
              We Offer The Best Of <span className="gradient-text font-bold">Every World</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-light">
              In a complex digital landscape that doesn't stop evolving, we champion agility by partnering with the best technologies and strategies.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {processes.map((process, index) => (
              <div key={index} className="scroll-animation text-center" style={{transitionDelay: `${index * 200}ms`}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="scroll-animation">
            ...
            <p className="text-xl font-light mb-8 max-w-2xl mx-auto">
              Let's discuss how our services can transform your digital presence and drive business growth.
            </p>
