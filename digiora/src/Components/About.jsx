...
import { 
  CheckCircle, Users, Target, TrendingUp, Award, ArrowRight, 
  Lightbulb, Shield, Clock, Globe, Star, MapPin, Phone, Mail,
  Calendar, ChevronRight, Heart, Zap, Eye, ExternalLink, X, ChevronLeft, Camera
} from 'lucide-react';
...
const AboutUsPage = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.querySelectorAll('.scroll-animation').forEach(el => observer.unobserve(el));
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.success && data.data && Array.isArray(data.data)) {
          const activeImages = data.data.map((image, index) => {
            // Add more debugging
  ...
  const values = [
    { 
      icon: Eye, 
      title: 'Vision', 
      description: 'To be the leading digital marketing agency that transforms businesses through innovative technology and creative excellence.' 
    },
    { 
      icon: Target, 
      title: 'Mission', 
      description: 'Empowering businesses to reach their full potential through strategic digital marketing solutions that deliver measurable results.' 
    },
    { 
      icon: Heart, 
      title: 'Values', 
      description: 'Innovation, integrity, collaboration, and client success drive everything we do at DigiOra Media.' 
    }
  ];
  ...
  const handleCTAAction = (action) => {
    switch (action) {
      case 'consultation':
        ...
        const message = 'Hello DigiOra Media! I would like to get started with your digital marketing services.';
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-animation">
              ...
              <p className="text-xl md:text-2xl font-light leading-relaxed mb-8">
                We are digital marketing pioneers, transforming businesses through innovative strategies and cutting-edge technology.
              </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/80">Cutting-edge strategies</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/80">25+ successful projects</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              <div className="scroll-animation mb-8">
                ...
                <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-6 leading-tight">
                  Driven To <span className="gradient-text font-bold">Inspire</span>
                </h2>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="scroll-animation">
              <div className="mb-8">
                ...
                <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-6 leading-tight">
                  Visionary Behind <span className="gradient-text font-bold">DigiOra Media</span>
                </h2>
              </div>
              
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Kalindu Kaveesha</h3>
                  <p className="text-red-600 font-semibold mb-4">CEO & Founder</p>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Kalindu Kaveesha is the founder of DigiOra Media Solutions (Pvt) Ltd, bringing over seven years of expertise in the social media and digital content industry. A B.Com (Special) graduate from the University of Sri Jayawardenepura, Kalindu seamlessly integrates business insight with creative storytelling to develop impactful digital strategies.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    As an accomplished entrepreneur and freelance photographer and videographer, he is dedicated to producing high-quality content that captivates audiences and strengthens brand presence. Kalindu’s vision is to drive innovation in the digital media landscape, delivering solutions that enable businesses to effectively engage and connect with their target markets.                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-lg italic leading-relaxed mb-4">
                        "At DigiOra Media, we don't just create campaigns – we craft digital experiences that transform businesses and drive meaningful connections between brands and their customers."
                      </p>
                  ...
                  <div className="relative bg-white rounded-2xl overflow-hidden shadow-xl">
                    ...
                    <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-3 shadow-lg">
                      <div className="text-center">
                        <div className="text-lg font-bold text-red-600">DigiOra</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="scroll-animation card-hover bg-white p-8 rounded-2xl text-center shadow-lg" style={{transitionDelay: `${index * 200}ms`}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div key={index} className="scroll-animation card-hover bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-2xl text-center" style={{transitionDelay: `${index * 200}ms`}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="scroll-animation">
              <h2 className="text-4xl md:text-4xl font-light text-gray-900 mb-6 leading-tight">
                Visual <span className="gradient-text font-bold">Masterpieces</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                Step into our world of creativity where digital marketing meets artistic excellence. Each piece tells a story of innovation and success.
              </p>
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600">We're preparing amazing visuals to showcase our work.</p>
            </div>
          ) : (
                    ...
                    <div className="relative overflow-hidden rounded-3xl">
                      ...
                      >
                        <img 
                          ...
                          onLoad={() => {
                            console.log('✅ Image loaded and displayed:', image.alt, image.image);
                          }}
                          onError={(e) => {
                            console.warn('❌ Image failed to load:', image.image);
                            console.log('Trying fallback image...');
                            e.target.src = 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80';
                          }}
                        />
     ...
     {/* Team Section 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="scroll-animation">
            ...
            <p className="text-xl font-light mb-8 max-w-2xl mx-auto">
              Let's discuss how DigiOra Media can help you achieve your digital marketing goals.
            </p>
      ...
      {selectedImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 modal-overlay bg-black/95" onClick={closeImageModal}>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-2xl">
              <div className="relative">
                <img 
                  ...
                  onError={(e) => {
                    console.warn('Modal image failed to load:', selectedImage.image);
                    e.target.src = 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80';
                  }}
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                  <div className="text-white">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-sm font-medium">Gallery Item {currentImageIndex + 1}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-gradient-to-r from-gray-50 to-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-500">Viewing {currentImageIndex + 1} of {galleryImages.length} images</p>
